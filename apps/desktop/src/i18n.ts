...
const chrome = {
  ...
  'map.label': 'Map', 'map.zoomOut': 'Zoom out', 'map.zoomIn': 'Zoom in', 'map.center': 'Center map', 'map.showAll': 'Show all', 'map.hint': 'Drag the empty map to pan. Scroll to zoom.', 'map.focus': 'Focused on {{title}}', 'map.reorganized': 'Graph reorganized',
...
const chromeTranslations: Record<Locale, ChromeDictionary> = {
  ...
  es: {
    ...
    'map.label': 'Mapa', 'map.zoomOut': 'Alejar', 'map.zoomIn': 'Acercar', 'map.center': 'Centrar mapa', 'map.showAll': 'Mostrar todo', 'map.hint': 'Arrastra el mapa vacío para desplazarte. Usa la rueda para ampliar.', 'map.focus': 'Enfocado en {{title}}', 'map.reorganized': 'Grafo reorganizado',
  ...
  pt: {
    ...
    'map.label': 'Mapa', 'map.zoomOut': 'Diminuir zoom', 'map.zoomIn': 'Aumentar zoom', 'map.center': 'Centralizar mapa', 'map.showAll': 'Mostrar tudo', 'map.hint': 'Arraste o mapa vazio para mover. Use a roda para ampliar.', 'map.focus': 'Foco em {{title}}', 'map.reorganized': 'Grafo reorganizado',
  ...
  fr: {
    ...
    'map.label': 'Carte', 'map.zoomOut': 'Dézoomer', 'map.zoomIn': 'Zoomer', 'map.center': 'Centrer la carte', 'map.showAll': 'Tout afficher', 'map.hint': 'Faites glisser la carte vide pour vous déplacer. Faites défiler pour zoomer.', 'map.focus': 'Centré sur {{title}}', 'map.reorganized': 'Graphe réorganisé',
  ...
  de: {
    ...
    'map.label': 'Karte', 'map.zoomOut': 'Verkleinern', 'map.zoomIn': 'Vergrößern', 'map.center': 'Karte zentrieren', 'map.showAll': 'Alles anzeigen', 'map.hint': 'Ziehe die leere Karte, um sie zu verschieben. Zum Zoomen scrollen.', 'map.focus': 'Fokus auf {{title}}', 'map.reorganized': 'Graph neu angeordnet',
  ...
  it: {
    ...
    'map.label': 'Mappa', 'map.zoomOut': 'Riduci zoom', 'map.zoomIn': 'Aumenta zoom', 'map.center': 'Centra mappa', 'map.showAll': 'Mostra tutto', 'map.hint': 'Trascina la mappa vuota per spostarti. Scorri per ingrandire.', 'map.focus': 'Focus su {{title}}', 'map.reorganized': 'Grafo riorganizzato',
  ...
  ja: {
    ...
    'map.label': 'マップ', 'map.zoomOut': '縮小', 'map.zoomIn': '拡大', 'map.center': 'マップを中央に戻す', 'map.showAll': 'すべて表示', 'map.hint': '何もない場所をドラッグして移動します。スクロールで拡大・縮小します。', 'map.focus': '{{title}} にフォーカス', 'map.reorganized': 'グラフを再配置しました',
  ...
  ko: {
    ...
    'map.label': '지도', 'map.zoomOut': '축소', 'map.zoomIn': '확대', 'map.center': '지도 가운데 맞춤', 'map.showAll': '모두 표시', 'map.hint': '빈 지도를 끌어 이동하세요. 스크롤하여 확대합니다.', 'map.focus': '{{title}}에 집중', 'map.reorganized': '그래프를 재정리했습니다',
  ...
  'zh-Hans': {
    ...
    'map.label': '图谱', 'map.zoomOut': '缩小', 'map.zoomIn': '放大', 'map.center': '居中图谱', 'map.showAll': '显示全部', 'map.hint': '拖动空白图谱即可平移。滚动可缩放。', 'map.focus': '聚焦于 {{title}}', 'map.reorganized': '图谱已重新整理',
  ...
  'zh-Hant': {
    ...
    'map.label': '圖譜', 'map.zoomOut': '縮小', 'map.zoomIn': '放大', 'map.center': '置中圖譜', 'map.showAll': '顯示全部', 'map.hint': '拖曳空白圖譜即可平移。捲動可縮放。', 'map.focus': '聚焦於 {{title}}', 'map.reorganized': '圖譜已重新整理',

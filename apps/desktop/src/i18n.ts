...
const english = {
  ...
  'ai.model': 'Model',
  'ai.modelPlaceholder': 'Runtime default',
  'ai.effort': 'Reasoning effort',
  'ai.default': 'Runtime default',
  'ai.none': 'None',
  'ai.minimal': 'Minimal',
  'ai.low': 'Low',
  'ai.medium': 'Medium',
  ...
  'ai.hint': 'Applies to Ingest, Query, Health, and tools in this brain.',
  ...
  'runtime.opencodeName': 'OpenCode (local, free — no account)',
  'runtime.opencodeDetail': 'Runs a small model on your Mac. No account, no API key. Downloads several GB the first time.',
  'opencode.kicker': 'Local runtime',
  'opencode.title': 'Setting up OpenCode',
  'opencode.copy': 'Eva is installing a local model so this brain works with no account and no API key. The first download is several GB; later brains reuse it.',
  'opencode.close': 'Close',
...
const dictionaries: Record<Locale, Dictionary> = {
  ...
  es: {
    ...
    'ai.model': 'Modelo', 'ai.modelPlaceholder': 'Valor predeterminado de la IA', 'ai.effort': 'Esfuerzo de razonamiento', 'ai.default': 'Valor predeterminado de la IA', 'ai.none': 'Ninguno', 'ai.minimal': 'Mínimo', 'ai.low': 'Bajo', 'ai.medium': 'Medio', 'ai.high': 'Alto', 'ai.xhigh': 'Muy alto', 'ai.max': 'Máximo', 'ai.ultra': 'Ultra', 'ai.savedModel': 'Modelo guardado', 'ai.hint': 'Se aplica a Ingesta, Consulta, Estado y herramientas de este cerebro.',
  ...
  pt: {
    ...
    'ai.model': 'Modelo', 'ai.modelPlaceholder': 'Padrão da IA', 'ai.effort': 'Esforço de raciocínio', 'ai.default': 'Padrão da IA', 'ai.none': 'Nenhum', 'ai.minimal': 'Mínimo', 'ai.low': 'Baixo', 'ai.medium': 'Médio', 'ai.high': 'Alto', 'ai.xhigh': 'Muito alto', 'ai.max': 'Máximo', 'ai.ultra': 'Ultra', 'ai.savedModel': 'Modelo guardado', 'ai.hint': 'Aplica-se à Ingestão, Consulta, Saúde e ferramentas deste cérebro.',
  ...
  fr: {
    ...
    'ai.model': 'Modèle', 'ai.modelPlaceholder': 'Valeur par défaut de l’IA', 'ai.effort': 'Effort de raisonnement', 'ai.default': 'Valeur par défaut de l’IA', 'ai.none': 'Aucun', 'ai.minimal': 'Minimal', 'ai.low': 'Faible', 'ai.medium': 'Moyen', 'ai.high': 'Élevé', 'ai.xhigh': 'Très élevé', 'ai.max': 'Maximum', 'ai.ultra': 'Ultra', 'ai.savedModel': 'Modèle enregistré', 'ai.hint': 'S’applique à l’intégration, aux questions, à la santé et aux outils de ce cerveau.',
  ...
  de: {
    ...
    'ai.model': 'Modell', 'ai.modelPlaceholder': 'KI-Standard', 'ai.effort': 'Denkaufwand', 'ai.default': 'KI-Standard', 'ai.none': 'Keine', 'ai.minimal': 'Minimal', 'ai.low': 'Niedrig', 'ai.medium': 'Mittel', 'ai.high': 'Hoch', 'ai.xhigh': 'Sehr hoch', 'ai.max': 'Maximum', 'ai.ultra': 'Ultra', 'ai.savedModel': 'Gespeichertes Modell', 'ai.hint': 'Gilt für Aufnahme, Abfragen, Zustand und Werkzeuge dieses Gehirns.',
  ...
  it: {
    ...
    'ai.model': 'Modello', 'ai.modelPlaceholder': 'Predefinito dell’IA', 'ai.effort': 'Impegno di ragionamento', 'ai.default': 'Predefinito dell’IA', 'ai.none': 'Nessuno', 'ai.minimal': 'Minimo', 'ai.low': 'Basso', 'ai.medium': 'Medio', 'ai.high': 'Alto', 'ai.xhigh': 'Molto alto', 'ai.max': 'Massimo', 'ai.ultra': 'Ultra', 'ai.savedModel': 'Modello salvato', 'ai.hint': 'Si applica a importazione, interrogazione, stato e strumenti di questo cervello.',
  ...
  ja: {
    ...
    'ai.model': 'モデル', 'ai.modelPlaceholder': 'AI の既定値', 'ai.effort': '推論の労力', 'ai.default': 'AI の既定値', 'ai.none': 'なし', 'ai.minimal': '最小', 'ai.low': '低い', 'ai.medium': '中', 'ai.high': '高い', 'ai.xhigh': '非常に高い', 'ai.max': '最大', 'ai.ultra': 'ウルトラ', 'ai.savedModel': '保存済みモデル', 'ai.hint': 'このブレインの取り込み、質問、状態、ツールに適用されます。',
  ...
  ko: {
    ...
    'ai.model': '모델', 'ai.modelPlaceholder': 'AI 기본값', 'ai.effort': '추론 강도', 'ai.default': 'AI 기본값', 'ai.none': '없음', 'ai.minimal': '최소', 'ai.low': '낮음', 'ai.medium': '보통', 'ai.high': '높음', 'ai.xhigh': '매우 높음', 'ai.max': '최대', 'ai.ultra': '울트라', 'ai.savedModel': '저장된 모델', 'ai.hint': '이 브레인의 수집, 질문, 상태 및 도구에 적용됩니다.',
  ...
  'zh-Hans': {
    ...
    'ai.model': '模型', 'ai.modelPlaceholder': '使用 AI 默认值', 'ai.effort': '推理强度', 'ai.default': '使用 AI 默认值', 'ai.none': '无', 'ai.minimal': '最小', 'ai.low': '低', 'ai.medium': '中', 'ai.high': '高', 'ai.xhigh': '极高', 'ai.max': '最高', 'ai.ultra': '超级', 'ai.savedModel': '已保存的模型', 'ai.hint': '适用于此大脑的导入、提问、健康检查和工具。',
  ...
  'zh-Hant': {
    ...
    'ai.model': '模型', 'ai.modelPlaceholder': '使用 AI 預設值', 'ai.effort': '推理強度', 'ai.default': '使用 AI 預設值', 'ai.none': '無', 'ai.minimal': '最小', 'ai.low': '低', 'ai.medium': '中', 'ai.high': '高', 'ai.xhigh': '極高', 'ai.max': '最高', 'ai.ultra': '超高', 'ai.savedModel': '已儲存的模型', 'ai.hint': '適用於此大腦的匯入、提問、健康檢查和工具。',
...
const chrome = {
  ...
  'map.label': 'Map', 'map.zoomOut': 'Zoom out', 'map.zoomIn': 'Zoom in', 'map.center': 'Center map', 'map.showAll': 'Show all', 'map.hint': 'Select a section or search to navigate. Drag empty space to pan.', 'map.focus': 'Focused on {{title}}', 'map.reorganized': 'Map reset to overview', 'map.reorganizeTitle': 'Return to the structural overview',
  'explore.button': 'Explore', 'explore.kicker': 'Navigate', 'explore.title': 'Explore brain', 'explore.searchLabel': 'Search pages', 'explore.searchPlaceholder': 'Search titles, notes, and sources…', 'explore.types': 'Page types', 'explore.clear': 'Clear', 'explore.connected': 'Only connections to the open page', 'explore.scope': 'Use this as my working set', 'explore.scopeCopy': 'Questions and tools will use only these pages.', 'explore.visible': '{{count}} pages visible', 'explore.none': 'No pages match these filters.', 'explore.scopeActive': 'Working set active · {{count}} pages',
  ...
  'health.pageClean': 'No lint issues.', 'health.pending': 'Reading the brain for maintenance signals…', 'health.none': 'No advisory maintenance work identified.', 'health.checkingStatus': 'Checking brain health…', 'health.findings': '{{count}} advisory findings', 'health.failed': 'Health check could not run', 'health.structural': 'Structural check', 'health.clean': 'No issues. Clean copy.', 'health.advisory': 'Advisory health check', 'health.intro': 'Read-only review for contradictions, weak provenance, stale claims, and research gaps.', 'health.running': 'Checking…', 'health.runAgain': 'Run again', 'health.run': 'Run health check',
} as const;
...
const chromeTranslations: Record<Locale, ChromeDictionary> = {
  ...
  es: {
    ...
    'map.label': 'Mapa', 'map.zoomOut': 'Alejar', 'map.zoomIn': 'Acercar', 'map.center': 'Centrar mapa', 'map.showAll': 'Mostrar todo', 'map.hint': 'Selecciona una sección o busca para navegar. Arrastra el espacio vacío para desplazarte.', 'map.focus': 'Enfocado en {{title}}', 'map.reorganized': 'Mapa restablecido a la vista general', 'map.reorganizeTitle': 'Volver a la vista estructural',
    'tool.menu': 'Herramientas', 'health.pageClean': 'No hay problemas de estructura.', 'health.pending': 'Leyendo el cerebro para detectar señales de mantenimiento…', 'health.none': 'No se ha identificado trabajo de mantenimiento recomendado.', 'health.checkingStatus': 'Comprobando el estado del cerebro…', 'health.findings': '{{count}} hallazgos recomendados', 'health.failed': 'No se pudo ejecutar la comprobación de estado', 'health.structural': 'Comprobación estructural', 'health.clean': 'Sin problemas. Todo está en orden.', 'health.advisory': 'Comprobación de estado recomendada', 'health.intro': 'Revisión de solo lectura de contradicciones, procedencia débil, afirmaciones desactualizadas y vacíos de investigación.', 'health.running': 'Comprobando…', 'health.runAgain': 'Ejecutar de nuevo', 'health.run': 'Comprobar estado',
    'explore.button': 'Explorar', 'explore.kicker': 'Navegar', 'explore.title': 'Explorar cerebro', 'explore.searchLabel': 'Buscar páginas', 'explore.searchPlaceholder': 'Busca títulos, notas y fuentes…', 'explore.types': 'Tipos de página', 'explore.clear': 'Limpiar', 'explore.connected': 'Solo conexiones de la página abierta', 'explore.scope': 'Usar como conjunto de trabajo', 'explore.scopeCopy': 'Las consultas y herramientas usarán solo estas páginas.', 'explore.visible': '{{count}} páginas visibles', 'explore.none': 'Ninguna página coincide con estos filtros.', 'explore.scopeActive': 'Conjunto de trabajo activo · {{count}} páginas',
  },
  pt: {
    ...
    'map.label': 'Mapa', 'map.zoomOut': 'Diminuir zoom', 'map.zoomIn': 'Aumentar zoom', 'map.center': 'Centralizar mapa', 'map.showAll': 'Mostrar tudo', 'map.hint': 'Selecione uma seção ou pesquise para navegar. Arraste o espaço vazio para mover.', 'map.focus': 'Foco em {{title}}', 'map.reorganized': 'Mapa restaurado à visão geral', 'map.reorganizeTitle': 'Voltar à visão estrutural',
    'tool.menu': 'Ferramentas', 'health.pageClean': 'Não há problemas de estrutura.', 'health.pending': 'Lendo o cérebro em busca de sinais de manutenção…', 'health.none': 'Nenhum trabalho de manutenção recomendado foi identificado.', 'health.checkingStatus': 'Verificando a saúde do cérebro…', 'health.findings': '{{count}} achados recomendados', 'health.failed': 'Não foi possível executar a verificação de saúde', 'health.structural': 'Verificação estrutural', 'health.clean': 'Sem problemas. Tudo em ordem.', 'health.advisory': 'Verificação de saúde recomendada', 'health.intro': 'Revisão somente leitura de contradições, procedência fraca, afirmações desatualizadas e lacunas de pesquisa.', 'health.running': 'Verificando…', 'health.runAgain': 'Executar novamente', 'health.run': 'Verificar saúde',
    'explore.button': 'Explorar', 'explore.kicker': 'Navegar', 'explore.title': 'Explorar cérebro', 'explore.searchLabel': 'Pesquisar páginas', 'explore.searchPlaceholder': 'Pesquise títulos, notas e fontes…', 'explore.types': 'Tipos de página', 'explore.clear': 'Limpar', 'explore.connected': 'Somente conexões da página aberta', 'explore.scope': 'Usar como meu conjunto de trabalho', 'explore.scopeCopy': 'Consultas e ferramentas usarão apenas estas páginas.', 'explore.visible': '{{count}} páginas visíveis', 'explore.none': 'Nenhuma página corresponde a estes filtros.', 'explore.scopeActive': 'Conjunto de trabalho ativo · {{count}} páginas',
  },
  fr: {
    ...
    'map.label': 'Carte', 'map.zoomOut': 'Dézoomer', 'map.zoomIn': 'Zoomer', 'map.center': 'Centrer la carte', 'map.showAll': 'Tout afficher', 'map.hint': 'Sélectionnez une section ou recherchez pour naviguer. Faites glisser l’espace vide pour vous déplacer.', 'map.focus': 'Centré sur {{title}}', 'map.reorganized': 'Carte rétablie à la vue d’ensemble', 'map.reorganizeTitle': 'Revenir à la vue structurelle',
    'tool.menu': 'Outils', 'health.pageClean': 'Aucun problème structurel.', 'health.pending': 'Lecture du cerveau à la recherche de signaux de maintenance…', 'health.none': 'Aucune maintenance consultative n’a été identifiée.', 'health.checkingStatus': 'Vérification de la santé du cerveau…', 'health.findings': '{{count}} constats consultatifs', 'health.failed': 'La vérification de santé n’a pas pu être exécutée', 'health.structural': 'Vérification structurelle', 'health.clean': 'Aucun problème. Texte propre.', 'health.advisory': 'Vérification de santé consultative', 'health.intro': 'Revue en lecture seule des contradictions, de la provenance faible, des affirmations obsolètes et des lacunes de recherche.', 'health.running': 'Vérification…', 'health.runAgain': 'Relancer', 'health.run': 'Vérifier la santé',
    'explore.button': 'Explorer', 'explore.kicker': 'Naviguer', 'explore.title': 'Explorer le cerveau', 'explore.searchLabel': 'Rechercher des pages', 'explore.searchPlaceholder': 'Recherchez des titres, notes et sources…', 'explore.types': 'Types de page', 'explore.clear': 'Effacer', 'explore.connected': 'Uniquement les liens de la page ouverte', 'explore.scope': 'Utiliser comme ensemble de travail', 'explore.scopeCopy': 'Les questions et outils n’utiliseront que ces pages.', 'explore.visible': '{{count}} pages visibles', 'explore.none': 'Aucune page ne correspond à ces filtres.', 'explore.scopeActive': 'Ensemble de travail actif · {{count}} pages',
  },
  de: {
    ...
    'map.label': 'Karte', 'map.zoomOut': 'Verkleinern', 'map.zoomIn': 'Vergrößern', 'map.center': 'Karte zentrieren', 'map.showAll': 'Alles anzeigen', 'map.hint': 'Wähle einen Abschnitt oder suche nach einer Seite. Ziehe leeren Raum zum Verschieben.', 'map.focus': 'Fokus auf {{title}}', 'map.reorganized': 'Karte auf Übersicht zurückgesetzt', 'map.reorganizeTitle': 'Zur strukturellen Übersicht zurückkehren',
    'tool.menu': 'Werkzeuge', 'health.pageClean': 'Keine Strukturprobleme.', 'health.pending': 'Das Gehirn wird auf Wartungssignale geprüft…', 'health.none': 'Es wurde kein beratender Wartungsbedarf erkannt.', 'health.checkingStatus': 'Gesundheit des Gehirns wird geprüft…', 'health.findings': '{{count}} beratende Befunde', 'health.failed': 'Die Gesundheitsprüfung konnte nicht ausgeführt werden', 'health.structural': 'Strukturprüfung', 'health.clean': 'Keine Probleme. Saubere Fassung.', 'health.advisory': 'Beratende Gesundheitsprüfung', 'health.intro': 'Schreibgeschützte Prüfung auf Widersprüche, schwache Herkunft, veraltete Behauptungen und Forschungslücken.', 'health.running': 'Wird geprüft…', 'health.runAgain': 'Erneut ausführen', 'health.run': 'Gesundheit prüfen',
    'explore.button': 'Erkunden', 'explore.kicker': 'Navigieren', 'explore.title': 'Gehirn erkunden', 'explore.searchLabel': 'Seiten durchsuchen', 'explore.searchPlaceholder': 'Titel, Notizen und Quellen durchsuchen…', 'explore.types': 'Seitentypen', 'explore.clear': 'Löschen', 'explore.connected': 'Nur Verbindungen zur offenen Seite', 'explore.scope': 'Als Arbeitsmenge verwenden', 'explore.scopeCopy': 'Fragen und Werkzeuge verwenden nur diese Seiten.', 'explore.visible': '{{count}} Seiten sichtbar', 'explore.none': 'Keine Seiten entsprechen diesen Filtern.', 'explore.scopeActive': 'Arbeitsmenge aktiv · {{count}} Seiten',
  },
  it: {
    ...
    'map.label': 'Mappa', 'map.zoomOut': 'Riduci zoom', 'map.zoomIn': 'Aumenta zoom', 'map.center': 'Centra mappa', 'map.showAll': 'Mostra tutto', 'map.hint': 'Seleziona una sezione o cerca per navigare. Trascina lo spazio vuoto per spostarti.', 'map.focus': 'Focus su {{title}}', 'map.reorganized': 'Mappa riportata alla panoramica', 'map.reorganizeTitle': 'Torna alla panoramica strutturale',
    'tool.menu': 'Strumenti', 'health.pageClean': 'Nessun problema strutturale.', 'health.pending': 'Lettura del cervello per cercare segnali di manutenzione…', 'health.none': 'Non è stato identificato alcun intervento di manutenzione consigliato.', 'health.checkingStatus': 'Controllo dello stato del cervello…', 'health.findings': '{{count}} risultati consigliati', 'health.failed': 'Non è stato possibile eseguire il controllo dello stato', 'health.structural': 'Controllo strutturale', 'health.clean': 'Nessun problema. Copia pulita.', 'health.advisory': 'Controllo dello stato consigliato', 'health.intro': 'Revisione in sola lettura di contraddizioni, provenienza debole, affermazioni obsolete e lacune di ricerca.', 'health.running': 'Controllo…', 'health.runAgain': 'Esegui di nuovo', 'health.run': 'Controlla stato',
    'explore.button': 'Esplora', 'explore.kicker': 'Naviga', 'explore.title': 'Esplora il cervello', 'explore.searchLabel': 'Cerca pagine', 'explore.searchPlaceholder': 'Cerca titoli, note e fonti…', 'explore.types': 'Tipi di pagina', 'explore.clear': 'Cancella', 'explore.connected': 'Solo collegamenti alla pagina aperta', 'explore.scope': 'Usa come insieme di lavoro', 'explore.scopeCopy': 'Domande e strumenti useranno solo queste pagine.', 'explore.visible': '{{count}} pagine visibili', 'explore.none': 'Nessuna pagina corrisponde a questi filtri.', 'explore.scopeActive': 'Insieme di lavoro attivo · {{count}} pagine',
  },
  ja: {
    ...
    'map.label': 'マップ', 'map.zoomOut': '縮小', 'map.zoomIn': '拡大', 'map.center': 'マップを中央に戻す', 'map.showAll': 'すべて表示', 'map.hint': 'セクションを選ぶか検索して移動します。何もない場所をドラッグして移動します。', 'map.focus': '{{title}} にフォーカス', 'map.reorganized': 'マップを概要表示に戻しました', 'map.reorganizeTitle': '構造の概要表示に戻る',
    'tool.menu': 'ツール', 'health.pageClean': '構造上の問題はありません。', 'health.pending': 'メンテナンスの兆候を調べるためブレインを読み込んでいます…', 'health.none': '推奨するメンテナンス作業は見つかりませんでした。', 'health.checkingStatus': 'ブレインの状態を確認しています…', 'health.findings': '推奨事項 {{count}} 件', 'health.failed': '状態チェックを実行できませんでした', 'health.structural': '構造チェック', 'health.clean': '問題はありません。きれいな状態です。', 'health.advisory': '推奨状態チェック', 'health.intro': '矛盾、弱い出典、古い主張、調査の不足を読み取り専用で確認します。', 'health.running': '確認中…', 'health.runAgain': 'もう一度実行', 'health.run': '状態を確認',
    'explore.button': '探索', 'explore.kicker': 'ナビゲート', 'explore.title': 'ブレインを探索', 'explore.searchLabel': 'ページを検索', 'explore.searchPlaceholder': 'タイトル、ノート、出典を検索…', 'explore.types': 'ページの種類', 'explore.clear': 'クリア', 'explore.connected': '開いているページへの接続のみ', 'explore.scope': '作業セットとして使う', 'explore.scopeCopy': '質問とツールはこれらのページだけを使います。', 'explore.visible': '{{count}} ページを表示中', 'explore.none': 'このフィルターに一致するページはありません。', 'explore.scopeActive': '作業セットが有効 · {{count}} ページ',
  },
  ko: {
    ...
    'map.label': '지도', 'map.zoomOut': '축소', 'map.zoomIn': '확대', 'map.center': '지도 가운데 맞춤', 'map.showAll': '모두 표시', 'map.hint': '섹션을 선택하거나 검색해 이동하세요. 빈 공간을 끌어 이동합니다.', 'map.focus': '{{title}}에 집중', 'map.reorganized': '지도를 개요로 되돌렸습니다', 'map.reorganizeTitle': '구조 개요로 돌아가기',
    'tool.menu': '도구', 'health.pageClean': '구조 문제가 없습니다.', 'health.pending': '유지 관리 신호를 찾기 위해 브레인을 읽는 중…', 'health.none': '권장되는 유지 관리 작업이 확인되지 않았습니다.', 'health.checkingStatus': '브레인 상태를 확인하는 중…', 'health.findings': '권장 항목 {{count}}개', 'health.failed': '상태 확인을 실행할 수 없습니다', 'health.structural': '구조 확인', 'health.clean': '문제가 없습니다. 깔끔한 상태입니다.', 'health.advisory': '권장 상태 확인', 'health.intro': '모순, 약한 출처, 오래된 주장 및 연구 공백을 읽기 전용으로 검토합니다.', 'health.running': '확인 중…', 'health.runAgain': '다시 실행', 'health.run': '상태 확인',
    'explore.button': '탐색', 'explore.kicker': '탐색하기', 'explore.title': '브레인 탐색', 'explore.searchLabel': '페이지 검색', 'explore.searchPlaceholder': '제목, 노트, 출처 검색…', 'explore.types': '페이지 유형', 'explore.clear': '지우기', 'explore.connected': '열린 페이지의 연결만', 'explore.scope': '작업 범위로 사용', 'explore.scopeCopy': '질문과 도구는 이 페이지들만 사용합니다.', 'explore.visible': '{{count}}개 페이지 표시', 'explore.none': '이 필터와 일치하는 페이지가 없습니다.', 'explore.scopeActive': '작업 범위 활성화 · {{count}}개 페이지',
  },
  'zh-Hans': {
    ...
    'map.label': '图谱', 'map.zoomOut': '缩小', 'map.zoomIn': '放大', 'map.center': '居中图谱', 'map.showAll': '显示全部', 'map.hint': '选择一个分区或搜索即可导航。拖动空白处可平移。', 'map.focus': '聚焦于 {{title}}', 'map.reorganized': '图谱已恢复为概览', 'map.reorganizeTitle': '返回结构概览',
    'tool.menu': '工具', 'health.pageClean': '没有结构问题。', 'health.pending': '正在读取大脑以查找维护信号…', 'health.none': '未发现建议的维护工作。', 'health.checkingStatus': '正在检查大脑健康状况…', 'health.findings': '{{count}} 项建议发现', 'health.failed': '无法运行健康检查', 'health.structural': '结构检查', 'health.clean': '没有问题。内容整洁。', 'health.advisory': '建议健康检查', 'health.intro': '以只读方式审查矛盾、薄弱来源、过时主张和研究空白。', 'health.running': '检查中…', 'health.runAgain': '再次运行', 'health.run': '运行健康检查',
    'explore.button': '探索', 'explore.kicker': '浏览', 'explore.title': '探索大脑', 'explore.searchLabel': '搜索页面', 'explore.searchPlaceholder': '搜索标题、笔记和来源…', 'explore.types': '页面类型', 'explore.clear': '清除', 'explore.connected': '仅显示与打开页面的连接', 'explore.scope': '用作我的工作范围', 'explore.scopeCopy': '问题和工具将只使用这些页面。', 'explore.visible': '显示 {{count}} 个页面', 'explore.none': '没有页面符合这些筛选条件。', 'explore.scopeActive': '工作范围已启用 · {{count}} 个页面',
  },
  'zh-Hant': {
    ...
    'map.label': '圖譜', 'map.zoomOut': '縮小', 'map.zoomIn': '放大', 'map.center': '置中圖譜', 'map.showAll': '顯示全部', 'map.hint': '選取一個區段或搜尋即可導覽。拖曳空白處可平移。', 'map.focus': '聚焦於 {{title}}', 'map.reorganized': '圖譜已回復為概覽', 'map.reorganizeTitle': '返回結構概覽',
    'tool.menu': '工具', 'health.pageClean': '沒有結構問題。', 'health.pending': '正在讀取大腦以尋找維護訊號…', 'health.none': '未發現建議的維護工作。', 'health.checkingStatus': '正在檢查大腦健康狀況…', 'health.findings': '{{count}} 項建議發現', 'health.failed': '無法執行健康檢查', 'health.structural': '結構檢查', 'health.clean': '沒有問題。內容整潔。', 'health.advisory': '建議健康檢查', 'health.intro': '以唯讀方式檢閱矛盾、薄弱來源、過時主張和研究空白。', 'health.running': '檢查中…', 'health.runAgain': '再次執行', 'health.run': '執行健康檢查',
    'explore.button': '探索', 'explore.kicker': '瀏覽', 'explore.title': '探索大腦', 'explore.searchLabel': '搜尋頁面', 'explore.searchPlaceholder': '搜尋標題、筆記和來源…', 'explore.types': '頁面類型', 'explore.clear': '清除', 'explore.connected': '只顯示與開啟頁面的連結', 'explore.scope': '用作我的工作範圍', 'explore.scopeCopy': '問題和工具只會使用這些頁面。', 'explore.visible': '顯示 {{count}} 個頁面', 'explore.none': '沒有頁面符合這些篩選條件。', 'explore.scopeActive': '工作範圍已啟用 · {{count}} 個頁面',
  },
};

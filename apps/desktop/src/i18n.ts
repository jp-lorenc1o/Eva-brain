...
const english = {
  ...
  'aria.home': 'Return to Eva’s brain library',
  'aria.close': 'Close',
} as const;
...
const dictionaries: Record<Locale, Dictionary> = {
  ...
  pt: {
    ...
    'settings.kicker': 'Eva', 'settings.title': 'Configurações do aplicativo', 'settings.copy': 'Escolha o idioma que Eva usa na interface. Isso não muda o idioma de trabalho de um cérebro.', 'settings.language': 'Idioma do aplicativo', 'settings.system': 'Usar idioma do sistema', 'settings.hint': 'Salvo somente neste dispositivo.', 'aria.home': 'Voltar à biblioteca de cérebros da Eva', 'aria.close': 'Fechar',
  },
  fr: {
    ...
    'settings.kicker': 'Eva', 'settings.title': 'Réglages de l’application', 'settings.copy': 'Choisissez la langue de l’interface d’Eva. Cela ne modifie pas la langue de travail d’un cerveau.', 'settings.language': 'Langue de l’application', 'settings.system': 'Utiliser la langue du système', 'settings.hint': 'Enregistré uniquement sur cet appareil.', 'aria.home': 'Revenir à la bibliothèque de cerveaux Eva', 'aria.close': 'Fermer',
  },
  de: {
    ...
    'settings.kicker': 'Eva', 'settings.title': 'App-Einstellungen', 'settings.copy': 'Wähle die Sprache der Eva-Oberfläche. Die Arbeitssprache eines Gehirns bleibt unverändert.', 'settings.language': 'App-Sprache', 'settings.system': 'Systemsprache verwenden', 'settings.hint': 'Nur auf diesem Gerät gespeichert.', 'aria.home': 'Zur Gehirnbibliothek von Eva zurückkehren', 'aria.close': 'Schließen',
  },
  it: {
    ...
    'settings.kicker': 'Eva', 'settings.title': 'Impostazioni dell’app', 'settings.copy': 'Scegli la lingua dell’interfaccia Eva. Non modifica la lingua di lavoro di un cervello.', 'settings.language': 'Lingua dell’app', 'settings.system': 'Usa la lingua di sistema', 'settings.hint': 'Salvato solo su questo dispositivo.', 'aria.home': 'Torna alla libreria dei cervelli di Eva', 'aria.close': 'Chiudi',
  },
  ja: {
    ...
    'settings.kicker': 'Eva', 'settings.title': 'アプリ設定', 'settings.copy': 'Eva のインターフェースで使う言語を選択します。ブレインの作業言語は変更されません。', 'settings.language': 'アプリの言語', 'settings.system': 'システム言語を使用', 'settings.hint': 'このデバイスにのみ保存されます。', 'aria.home': 'Eva のブレインライブラリに戻る', 'aria.close': '閉じる',
  },
  ko: {
    ...
    'settings.kicker': 'Eva', 'settings.title': '앱 설정', 'settings.copy': 'Eva 인터페이스에서 사용할 언어를 선택하세요. 브레인의 작업 언어는 바뀌지 않습니다.', 'settings.language': '앱 언어', 'settings.system': '시스템 언어 사용', 'settings.hint': '이 기기에만 저장됩니다.', 'aria.home': 'Eva 브레인 라이브러리로 돌아가기', 'aria.close': '닫기',
  },
  'zh-Hans': {
    ...
    'settings.kicker': 'Eva', 'settings.title': '应用设置', 'settings.copy': '选择 Eva 界面使用的语言。这不会改变大脑的工作语言。', 'settings.language': '应用语言', 'settings.system': '使用系统语言', 'settings.hint': '仅保存在此设备上。', 'aria.home': '返回 Eva 的大脑资料库', 'aria.close': '关闭',
  },
  'zh-Hant': {
    ...
    'settings.kicker': 'Eva', 'settings.title': '應用程式設定', 'settings.copy': '選擇 Eva 介面使用的語言。這不會變更大腦的工作語言。', 'settings.language': '應用程式語言', 'settings.system': '使用系統語言', 'settings.hint': '僅儲存在此裝置上。', 'aria.home': '返回 Eva 的大腦資料庫', 'aria.close': '關閉',
  },
};

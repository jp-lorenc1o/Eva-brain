...
const dictionaries: Record<Locale, Dictionary> = {
  ...
  es: {
    ...
    'ai.model': 'Modelo', 'ai.modelPlaceholder': 'Valor predeterminado de la IA', 'ai.effort': 'Esfuerzo de razonamiento', 'ai.default': 'Valor predeterminado de la IA', 'ai.low': 'Bajo', 'ai.medium': 'Medio', 'ai.high': 'Alto', 'ai.xhigh': 'Muy alto', 'ai.max': 'Máximo', 'ai.hint': 'Se aplica a Ingesta, Consulta, Estado y herramientas de este cerebro.',
  ...
  pt: {
    ...
    'ai.model': 'Modelo', 'ai.modelPlaceholder': 'Padrão da IA', 'ai.effort': 'Esforço de raciocínio', 'ai.default': 'Padrão da IA', 'ai.low': 'Baixo', 'ai.medium': 'Médio', 'ai.high': 'Alto', 'ai.xhigh': 'Muito alto', 'ai.max': 'Máximo', 'ai.hint': 'Aplica-se à Ingestão, Consulta, Saúde e ferramentas deste cérebro.',
  ...
  fr: {
    ...
    'ai.model': 'Modèle', 'ai.modelPlaceholder': 'Valeur par défaut de l’IA', 'ai.effort': 'Effort de raisonnement', 'ai.default': 'Valeur par défaut de l’IA', 'ai.low': 'Faible', 'ai.medium': 'Moyen', 'ai.high': 'Élevé', 'ai.xhigh': 'Très élevé', 'ai.max': 'Maximum', 'ai.hint': 'S’applique à l’intégration, aux questions, à la santé et aux outils de ce cerveau.',
  ...
  de: {
    ...
    'ai.model': 'Modell', 'ai.modelPlaceholder': 'KI-Standard', 'ai.effort': 'Denkaufwand', 'ai.default': 'KI-Standard', 'ai.low': 'Niedrig', 'ai.medium': 'Mittel', 'ai.high': 'Hoch', 'ai.xhigh': 'Sehr hoch', 'ai.max': 'Maximum', 'ai.hint': 'Gilt für Aufnahme, Abfragen, Zustand und Werkzeuge dieses Gehirns.',
  ...
  it: {
    ...
    'ai.model': 'Modello', 'ai.modelPlaceholder': 'Predefinito dell’IA', 'ai.effort': 'Impegno di ragionamento', 'ai.default': 'Predefinito dell’IA', 'ai.low': 'Basso', 'ai.medium': 'Medio', 'ai.high': 'Alto', 'ai.xhigh': 'Molto alto', 'ai.max': 'Massimo', 'ai.hint': 'Si applica a importazione, interrogazione, stato e strumenti di questo cervello.',
  ...
  ja: {
    ...
    'ai.model': 'モデル', 'ai.modelPlaceholder': 'AI の既定値', 'ai.effort': '推論の労力', 'ai.default': 'AI の既定値', 'ai.low': '低い', 'ai.medium': '中', 'ai.high': '高い', 'ai.xhigh': '非常に高い', 'ai.max': '最大', 'ai.hint': 'このブレインの取り込み、質問、状態、ツールに適用されます。',
  ...
  ko: {
    ...
    'ai.model': '모델', 'ai.modelPlaceholder': 'AI 기본값', 'ai.effort': '추론 강도', 'ai.default': 'AI 기본값', 'ai.low': '낮음', 'ai.medium': '보통', 'ai.high': '높음', 'ai.xhigh': '매우 높음', 'ai.max': '최대', 'ai.hint': '이 브레인의 수집, 질문, 상태 및 도구에 적용됩니다.',
  ...
  'zh-Hans': {
    ...
    'ai.model': '模型', 'ai.modelPlaceholder': '使用 AI 默认值', 'ai.effort': '推理强度', 'ai.default': '使用 AI 默认值', 'ai.low': '低', 'ai.medium': '中', 'ai.high': '高', 'ai.xhigh': '极高', 'ai.max': '最高', 'ai.hint': '适用于此大脑的导入、提问、健康检查和工具。',
  ...
  'zh-Hant': {
    ...
    'ai.model': '模型', 'ai.modelPlaceholder': '使用 AI 預設值', 'ai.effort': '推理強度', 'ai.default': '使用 AI 預設值', 'ai.low': '低', 'ai.medium': '中', 'ai.high': '高', 'ai.xhigh': '極高', 'ai.max': '最高', 'ai.hint': '適用於此大腦的匯入、提問、健康檢查和工具。',
